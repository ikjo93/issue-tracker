...
public class IssueController {
    ...
    public IssueDtos getIssues(IssueSearchCondition condition) {
    ...
    @PatchMapping("/api/issues/status")
    ...
    @PatchMapping("/api/issues/{id}/subject")
    ...
    @PatchMapping("/api/issues/{id}/milestone")
    ...
    @PatchMapping("/api/issues/{id}/labels")
    ...
    @PatchMapping("/api/issues/{id}/assignees")
